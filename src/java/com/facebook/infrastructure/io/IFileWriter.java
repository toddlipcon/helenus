...
/**
 * An interface for writing into the SequenceFile abstraction. Author : Avinash
...
public interface IFileWriter {
   ...
   * 
   * @param key
   *          key associated with this peice of data.
   * @param buffer
  ...
  /**
   * Appends the key and the long value to the the underlying SequenceFile. This
   * is used in the contruction of the index file associated with a SSTable.
   * 
   * @param key
   *          key associated with this peice of data.
   * @param value
  ...
  /**
   * Be extremely careful while using this API. This currently used to write the
   * commit log header in the commit logs. If not used carefully it could
