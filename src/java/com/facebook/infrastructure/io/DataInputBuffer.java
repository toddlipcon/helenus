...
/**
 * An implementation of the DataInputStream interface. This instance is
...
public final class DataInputBuffer extends DataInputStream {
  /*
   * This is a clone of the ByteArrayInputStream class w/o any method being
   * synchronized.
   */
  ...
  public static void main(String[] args) throws Throwable {
     ...
     * bufOut.writeUTF("Avinash"); bufOut.writeInt(4110241024); DataInputBuffer
     * bufIn = new DataInputBuffer(); bufIn.reset(bufOut.getData(),
     * bufOut.getLength()); System.out.println(bufIn.readUTF());
