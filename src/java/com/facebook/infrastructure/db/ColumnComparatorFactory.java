...
public class ColumnComparatorFactory {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Result of compare: "
        + getComparator(ComparatorType.NAME).compare(col1, col2));
  }
}

abstract class AbstractColumnComparator implements Comparator<IColumn>,
    Serializable {
  protected ColumnComparatorFactory.ComparatorType comparatorType_;

  public AbstractColumnComparator(
      ColumnComparatorFactory.ComparatorType comparatorType) {
