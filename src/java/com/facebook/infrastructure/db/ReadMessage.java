...
public class ReadMessage implements Serializable {
  ...
  public static Message makeReadMessage(ReadMessage readMessage)
      throws IOException {
    ...
    Message message = new Message(StorageService.getLocalStorageEndPoint(),
        StorageService.readStage_, StorageService.readVerbHandler_,
...
class ReadMessageSerializer implements ICompactSerializer<ReadMessage> {
  public void serialize(ReadMessage rm, DataOutputStream dos)
      throws IOException {
