...
public class ReadResponseMessage implements Serializable {
  ...
  public static Message makeReadResponseMessage(
      ReadResponseMessage readResponseMessage) throws IOException {
...
class ReadResponseMessageSerializer implements
  ...
  public ReadResponseMessage deserialize(DataInputStream dis)
      throws IOException {
