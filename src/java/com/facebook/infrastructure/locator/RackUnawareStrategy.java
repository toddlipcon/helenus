...
/**
 * This class returns the nodes responsible for a given key but does not respect
 * rack awareness. Basically returns the 3 nodes that lie right next to each
 * other on the ring.
 */
public class RackUnawareStrategy extends AbstractStrategy {
  ...
  public EndPoint[] getStorageEndPoints(BigInteger token,
    ...
    // If we found N number of nodes we are good. This loop will just exit.
    // Otherwise just
