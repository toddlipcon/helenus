...
public class TokenMetadata {
  ...
  protected TokenMetadata(Map<BigInteger, EndPoint> tokenToEndPointMap,
      Map<EndPoint, BigInteger> endPointToTokenMap) {
...
class TokenMetadataSerializer implements ICompactSerializer<TokenMetadata> {
  public void serialize(TokenMetadata tkMetadata, DataOutputStream dos)
      throws IOException {
    Map<BigInteger, EndPoint> tokenToEndPointMap = tkMetadata
    ...
    for (BigInteger token : tokens) {
      ...
      CompactEndPointSerializationHelper.serialize(tokenToEndPointMap
          .get(token), dos);
    }
  }
