 ...
 * element interface generated in the com.facebook.infrastructure.loader
 * package.
 * <p>
...
public class ObjectFactory {
   ...
   * schema derived classes for package: com.facebook.infrastructure.loader
   * 
   */
  ...
  /**
   * Create an instance of {@link JAXBElement }{@code <}{@link SuperColumnType }
   * {@code >}
   * 
   */
  @XmlElementDecl(namespace = "", name = "SuperColumn")
  public JAXBElement<SuperColumnType> createSuperColumn(SuperColumnType value) {
    return new JAXBElement<SuperColumnType>(_SuperColumn_QNAME,
        SuperColumnType.class, null, value);
  }
  ...
  public JAXBElement<ColumnType> createColumn(ColumnType value) {
    return new JAXBElement<ColumnType>(_Column_QNAME, ColumnType.class, null,
        value);
  }
