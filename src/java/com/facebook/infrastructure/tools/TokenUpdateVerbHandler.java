...
public class TokenUpdateVerbHandler implements IVerbHandler {
  ...
  public void doVerb(Message message) {
    ...
    try {
      ...
      TokenUpdater.TokenInfoMessage tiMessage = TokenUpdater.TokenInfoMessage
      ...
      for (String node : nodes) {
        ...
        EndPoint target = new EndPoint(node, DatabaseDescriptor
            .getStoragePort());
        ...
        logger_.debug("Sending a token update message to " + target
            + " to update it to " + token);
