...
public class KeyExtracter {
  ...
  public static void main(String[] args) throws Throwable {
    if (args.length != 3) {
      System.out
          .println("Usage : java com.facebook.infrastructure.tools.IndexBuilder <key to extract> <data file> <output file>");
      System.exit(1);
    }
  ...
  public static boolean extractKeyIntoFile(String keyToExtract,
  ...
  private static void dumpBlockIndex(String key, long position, long size,
