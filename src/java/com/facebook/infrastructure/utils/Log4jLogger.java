...
/**
 * Log4j configurations may change while the application is running, potentially
 * invalidating a logger's appender(s). This is a convinience class to wrap
 * logger calls so that a logger is always explicitly invoked.
 */
