 ...
 * bits can be examined, set, or cleared. One <code>BitSet</code> may be used to
 * modify the contents of another <code>BitSet</code> through logical AND,
...
public class BitSet implements Cloneable, java.io.Serializable {
   ...
   * 
   *              The bits in this BitSet. The ith bit is stored in bits[i/64]
   *              at bit position i % 64 (where bit position 0 refers to the
   *              least significant bit and 63 refers to the most significant
   *              bit).
   */
   ...
   * 
   * @param words
   *          the array which we use to defreeze the BitSet.
   */
   ...
   * highest set bit in the <code>BitSet</code> plus one. Returns zero if the
   * <code>BitSet</code> contains no set bits.
   * 
  ...
  /**
   * Returns true if this <code>BitSet</code> contains no bits that are set to
   * <code>true</code>.
   * 
   ...
   * @return boolean indicating whether this <code>BitSet</code> intersects the
   ...
   * .
   * 
   * @return the number of bits set to <tt>true</tt> in this <code>BitSet</code>
   *         .
   * @since 1.4
   */
   ...
   * <code>true</code> or the corresponding bit in the bit set argument has the
  ...
  /**
   * Clears all of the bits in this <code>BitSet</code> whose corresponding bit
   * is set in the specified <code>BitSet</code>.
   * 
   * @param set
   ...
   * <code>BitSet</code> to represent bit values. The maximum element in the set
   ...
   * is a <code>Bitset</code> object that has exactly the same set of bits set
   * to <code>true</code> as this bit set. That is, for every nonnegative
  ...
  /**
   * Cloning this <code>BitSet</code> produces a new <code>BitSet</code> that is
   * equal to it. The clone of the bit set is another bit set that has exactly
   * the same bits set to <code>true</code> as this bit set.
   * 
   * <p>
  ...
  /**
   * Save the state of the <tt>BitSet</tt> instance to a stream (i.e., serialize
   * it).
   */
  ...
  /**
   * Reconstitute the <tt>BitSet</tt> instance from a stream (i.e., deserialize
   * it).
   */
   ...
   * this <code>BitSet</code> contains a bit in the set state, the decimal
