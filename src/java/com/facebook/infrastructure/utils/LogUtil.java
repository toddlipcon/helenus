...
public class LogUtil {
  ...
  public static String throwableToString(Throwable e) {
    ...
    sbuf.append((new StringBuilder()).append("Exception was generated at : ")
        .append(getTimestamp()).append(" on thread ").append(
  ...
  public static String getLogMessage(String message) {
    StringBuffer sbuf = new StringBuffer((new StringBuilder()).append(
