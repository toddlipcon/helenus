...
public class MetricValue {
   ...
   * 
   * @param number
   *          this initializes the initial value of this metric
   * @param isIncrement
   *          sets if the metric can be incremented or only set
   */
   ...
   * 
   * @return true if the value of this metric can be incremented, false
   *         otherwise
   */
