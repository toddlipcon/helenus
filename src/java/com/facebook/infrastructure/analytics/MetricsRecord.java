...
/**
 * This class keeps a back-pointer to the AnalyticsContext and delegates back to
 * it on <code>update</code> and <code>remove()</code>.
 * 
...
public class MetricsRecord {
   ...
   *          name of this record
   * @param context
   *          the context which this record is a part of
   */
   ...
   * @throws MetricsException
   *           if the metricName or the type of the metricValue conflicts with
   *           the configuration
   */
  ...
  /**
   * Sets the value of the metric identified by metricName with the number
   * metricValue.
   * 
   * @param metricName
   *          name of the metric
   * @param metricValue
   *          number value to which it should be updated
   */
  ...
  /**
   * Increments the value of the metric identified by metricName with the number
   * metricValue.
   * 
   * @param metricName
   *          name of the metric
   * @param metricValue
   *          number value by which it should be incremented
   */
  ...
  /**
   * Updates the table of buffered data which is to be sent periodically. If the
   * tag values match an existing row, that row is updated; otherwise, a new row
   * is added.
   */
  public void update() {
    context.update(this);
  ...
  /**
   * Removes the row, if it exists, in the buffered data table having tags that
   * equal the tags that have been set on this record.
   */
  public void remove() {
    context.remove(this);
  }
