 ...
 * please refer to the <i>IStage</i> documentation. Author : Avinash Lakshman (
...
public class SingleThreadedStage implements IStage {
  ...
  public SingleThreadedStage(String name) {
    ...
    executorService_ = new DebuggableThreadPoolExecutor(1, 1,
        Integer.MAX_VALUE, TimeUnit.SECONDS,
        new LinkedBlockingQueue<Runnable>(), new ThreadFactoryImpl(name));
    name_ = name;
  }
  ...
  public ScheduledFuture<?> scheduleWithFixedDelay(Runnable command,
    ...
    // return executorService_.scheduleWithFixedDelay(command, initialDelay,
    // delay, unit);
    throw new UnsupportedOperationException("This operation is not supported");
  }
  ...
  public long getTaskCount() {
    return (executorService_.getTaskCount() - executorService_
