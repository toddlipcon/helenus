...
/**
 * This class manages all stages that exist within a process. The application
 * registers and de-registers stages with this abstraction. Any component that
 * has the <i>ID</i> associated with a stage can obtain a handle to actual
 * stage.
 * 
...
public class StageManager {
   ...
   *          stage name.
   * @param stage
   *          stage for the respective message types.
   */
