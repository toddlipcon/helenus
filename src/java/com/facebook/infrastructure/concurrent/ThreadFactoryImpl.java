 ...
 * is useful to give Java threads meaningful names which is useful when using a
 * tool like JConsole. Author : Avinash Lakshman ( alakshman@facebook.com) &
...
public class ThreadFactoryImpl implements ThreadFactory {
  ...
  public ThreadFactoryImpl(String id) {
    ...
    threadGroup_ = (sm != null) ? sm.getThreadGroup() : Thread.currentThread()
        .getThreadGroup();
    id_ = id;
  }
