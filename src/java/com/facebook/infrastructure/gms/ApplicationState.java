 ...
 * cluster. Whenever a peice of state needs to be disseminated to the rest of
 * cluster wrap the state in an instance of <i>ApplicationState</i> and add it
 * to the Gossiper.
 * 
 * For eg. if we want to disseminate load information for node A do the
 * following:
 * 
 * ApplicationState loadState = new ApplicationState(<string reprensentation of
...
public class ApplicationState {
   ...
   * 
   * @param state
   *          string representation of arbitrary state.
   */
