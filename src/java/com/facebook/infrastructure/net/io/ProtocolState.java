  ...
  public void morphState() throws IOException {
    ...
    if (MessagingService.isProtocolValid(protocol)) {
      StartState nextState = stream_
          .getSocketState(TcpReader.TcpReaderState.PROTOCOL);
      if (nextState == null) {
      ...
      throw new IOException(
          "Invalid protocol header. The preamble seems to be messed up.");
    }
  }

  public void setContextData(Object data) {
    throw new UnsupportedOperationException(
        "This method is not supported in the ProtocolState");
  }
}
