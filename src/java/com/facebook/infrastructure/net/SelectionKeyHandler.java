...
public class SelectionKeyHandler {
  public void modifyKey(SelectionKey key) {
    throw new UnsupportedOperationException("modifyKey() cannot be called on "
        + getClass().getName() + "!");
  }

  public void modifyKeyForRead(SelectionKey key) {
    throw new UnsupportedOperationException(
        "modifyKeyForRead() cannot be called on " + getClass().getName() + "!");
  }

  public void modifyKeyForWrite(SelectionKey key) {
    throw new UnsupportedOperationException(
        "modifyKeyForWrite() cannot be called on " + getClass().getName() + "!");
  }
  ...
  public void accept(SelectionKey key) {
    throw new UnsupportedOperationException("accept() cannot be called on "
        + getClass().getName() + "!");
  }
  ...
  public void connect(SelectionKey key) {
    throw new UnsupportedOperationException("connect() cannot be called on "
        + getClass().getName() + "!");
  }
  ...
  public void write(SelectionKey key) {
    throw new UnsupportedOperationException("write() cannot be called on "
        + getClass().getName() + "!");
  }
}
