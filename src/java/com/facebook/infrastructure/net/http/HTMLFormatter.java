...
public class HTMLFormatter {
  ...
  public void startBody(boolean writeJSCallback, String jsCallbackFunction,
      boolean writeCSS, boolean writeBody) {
  ...
  public void addCombobox(Set<String> comboBoxEntries, String htmlElementName,
    ...
    for (String colFamName : comboBoxEntries) {
      if (defaultSelected == i) {
        sb_.append("    <option value=\"" + colFamName + "\" SELECTED>"
            + colFamName + "\n");
      } else {
  ...
  public void addCSS() {
    ...
    sb_.append("}\n");
    sb_
        .append("a:link {color:#CAF99B;font-size:10pt;font-weight:bold;font-family:Arial Unicode MS,Lucida-grande,Verdana}\n");
    sb_.append("a:visited {color:red}\n");
    sb_
        .append("a:hover{color:yellow;font-size:10pt;font-weight:bold;font-family:Arial Unicode MS,Lucida-grande,Verdana;background-color:green}\n");
