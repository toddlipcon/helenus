...
public class HttpRequest {
  ...
  /*
   * Gets the request path referenced by the request. For example, if the URL is
   * of the form: http://somedomain:PORT/some/path?param=value this function
  ...
  /*
   * Gets the query in the request. For example, if the URL is of the form:
   * http://somedomain:PORT/some/path?param=value this function will return
   * "/some/path"
   */
  ...
  /*
   * This function add to the map of header name-values in the HTTP request.
   */
  ...
  /*
   * For a gives name, returns the value if it was in the headers. Returns the
  ...
  public void setParameter(String name, String value) {
    // first decode the data then store it in the map using the standard UTF-8
    // encoding
  ...
  /*
   * This function get the parameters from the body of the HTTP message. Returns
   * the value for the parameter if one exists or returns null.
   * 
   * z For example, if the body is of the form: a=b&c=d this function will:
  ...
  /*
   * Get the string representation of the byte buffers passed in and put them in
   * sBody_ variable. Then parse all the parameters in the body.
   */
  ...
  public void setStartLine(String method, String path, String query,
      String version) {
    method_ = method;
    path_ = path;
    query_ = query;
  ...
  public String toString() {
    ...
    pw.println("method = " + method_ + ", path = " + path_ + ", query = "
        + query_ + ", version = " + version_);
