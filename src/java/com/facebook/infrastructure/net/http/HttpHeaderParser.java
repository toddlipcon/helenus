...
public class HttpHeaderParser {
  ...
  enum HeaderParseState {
     ...
     * HeaderValue\r\n this is still part of the value
     * 
     * NOTE: while all whitespace should generally be condensed into a single
     * space by the HTTP standard, we will just preserve all of the whitespace
     * for now
     * 
  ...
  private void finishCurrentHeader_() {
    if (callback_ != null) {
      callback_.onHeader(headerKey_.toString().trim(), headerValue_.toString()
          .trim());
    }
    resetParserState();
  }
