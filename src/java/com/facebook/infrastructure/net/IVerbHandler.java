 ...
 * for a given verb. Author : Avinash Lakshman ( alakshman@facebook.com) &
...
public interface IVerbHandler {
   ...
   * MessagingService.registerVerbHandlers). Note that the caller should not be
   * holding any locks when calling this method because the implementation may
   * be synchronized.
   * 
   * @param message
